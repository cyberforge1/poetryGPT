...
3. Create a new finely-tuned model using the following project link (https://github.com/cyberforge1/chat-gpt-fine-tuning) and copy the model name.
...
## Challenges
- An interesting challenge encountered on this project was understanding the type of data being returned and how to best display it in the interface. Initially, it seems that there were grammatical errors in the response because new phrases were attached directly to previous phrases and with capitalized letters. After mistakenly trying to correct the grammar of the responses, I looked back at the training data, and realized that limericks are structured this way. Therefore, to correct this issue, all that was necessary was to break the response onto a new line when the phrase delimiter was encountered.  
